...
TaskTitleStr = Annotated[
    str, StringConstraints(min_length=1, max_length=200, strip_whitespace=True)
]
TaskDescriptionStr = Annotated[
...
EmailStr = Annotated[
    str,
    StringConstraints(
        min_length=1, max_length=120, strip_whitespace=True, to_lower=True
    ),
]
PasswordStr = Annotated[str, StringConstraints(min_length=8, max_length=128)]
UUIDStr = Annotated[
    str, StringConstraints(min_length=1, max_length=36, strip_whitespace=True)
]
